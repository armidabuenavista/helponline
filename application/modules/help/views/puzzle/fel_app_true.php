        ...
        <div class="panel">
            <button type="button" class="btn btn-info btn-sm" data-toggle="collapse" data-target="#demo"><i class="fa fa-plus"></i> Add New Data</button>
                <div id="demo" class="collapse">
                    <form method="post" class="form-horizontal" role="form" enctype="multipart/form-data" action="<?=base_url('help/fel_app_true_add_process');?>">
                        
                        <label for="title" class="control-label">FEL True Category: </label>
                        <div class="row">
                            <div class="col-sm-9">
                                <input type="text" name="title_1" required id="title_1" class="form-control" placeholder="Name/True">
                            </div>
                            <div class="col-sm-3">
            ...
            <div class="panel-body">
                <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="" data-sort-order="asc" class="table table-bordered table-responsive table-striped table table-hover table-striped">
                    <thead>
                        <tr>
                            <th data-field="name" data-sortable="true" >Name/True </th>
    ...
    <div class="modal fade" id="<?="brochure_view_".$value->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <?=form_open_multipart(base_url().'help/fel_app_true_edit_process/'.$value->id); ?>
                    
                        <label for="title" class="control-label">Title of Statements: </label>
                        <div class="row">
                            <div class="col-sm-9">
                                <input type="text" value="<?=$value->true_app; ?>" name="title_1" required id="title_1" class="form-control" placeholder="Name/True">
                            </div>
                            <div class="col-sm-3">
        ...
        function(isConfirm){
          if (isConfirm) {
            swal({
                ...
                function(){
                  window.location.href="<?=base_url(); ?>help/fel_app_true_delete_process/"+del_id;
                });
          } else {
