...
<style>
    ...
    <div style="margin: 30px;">
        <h3>Pingang Pinoy:<small> (Data Manupulation Module)</small></h3>
    </div>
    <hr>
    <div style="margin: 30px;">
        ...
        <div class="panel">
            <button type="button" class="btn btn-info btn-sm" data-toggle="collapse" data-target="#demo"><i class="fa fa-plus"></i> Add New Data</button>
                <div id="demo" class="collapse">
                    <form method="post" class="form-horizontal" role="form" enctype="multipart/form-data" action="<?=base_url('help/pingang_pinoy_add_process');?>">
    ...
    <div class="modal fade" id="<?="brochure_view_".$value->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <?=form_open_multipart(base_url().'help/pingang_pinoy_edit_process/'.$value->id); ?>
                    
                        <label for="title" class="control-label">Title of Statements: </label>
                        <div class="row">
                            <div class="col-sm-10">
                                <input type="text" value="<?=$value->title; ?>" name="title" required id="title" class="form-control" placeholder="Enter the Title">
                            </div>
                            <div class="col-sm-2">
                                ...
                                <label for="title" class="control-label">Facts/ Information/ Content: </label>
                                <textarea id="mytextarea" name="description" class="tinymce" placeholder="Description"> <?=$value->description; ?></textarea>  
        ...
        function(isConfirm){
          if (isConfirm) {
            swal({
                ...
                function(){
                  window.location.href="<?=base_url(); ?>help/pingang_pinoy_delete_process/"+del_id;
                });
          } else {
