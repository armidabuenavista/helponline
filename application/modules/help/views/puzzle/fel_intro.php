        ...
        <div class="panel">
            <button type="button" class="btn btn-info btn-sm" data-toggle="collapse" data-target="#demo"><i class="fa fa-plus"></i> Add New Data</button>
                <div id="demo" class="collapse">
                    <form method="post" class="form-horizontal" role="form" enctype="multipart/form-data" action="<?=base_url('help/fel_add_process');?>">
    ...
    <div class="modal fade" id="<?="brochure_view_".$value->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <?=form_open_multipart(base_url().'help/fel_edit_process/'.$value->id); ?>
        ...
        function(isConfirm){
          if (isConfirm) {
            swal({
                ...
                function(){
                  window.location.href="<?=base_url(); ?>help/fel_delete_process/"+del_id;
                });
          } else {
