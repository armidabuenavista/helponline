                ...
                <div class="panel-body">
                    <div class="row">
                            <?php
                                ...
                                foreach ($this->load->mdl_help->get_fel_content() as $value) { if($value->image_lib==""){ $picture="no_photo.png"; }else{ $picture=$value->image_lib; } ?>
                        <div class="col-sm-3"> 
                            <center><p><b><?=$value->name_e;?></b></p></center>
                            <a type="button" href="<?=base_url();?>help/food_photo_upload/<?=$value->id;?>"> <img width="100%" height="300" src="<?=base_url();?>assets/images/fel_photo/<?=$picture;?>"></a>
                        </div>
                           <?php } ?>
                    </div>
                </div>
