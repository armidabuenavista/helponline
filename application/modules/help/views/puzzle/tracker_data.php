...
<style>
    ...
    <div style="margin: 30px;">
        <h3>Help Online Tracker Page Repository of Data Repository:<small> (Data Manupulation Module)</small></h3>
    </div>
    <hr>
    <div style="margin: 30px;">
        ...
        <div class="panel">
            <button type="button" class="btn btn-info btn-sm" data-toggle="collapse" data-target="#demo"><i class="fa fa-plus"></i> Add New Data</button>
                <div id="demo" class="collapse">
                    <form method="post" class="form-horizontal" role="form" enctype="multipart/form-data" action="<?php echo base_url('help/tracker_add_process');?>">
                  ...
                  <tbody>
                            ...
                            <?php
                              $this->load->model('mdl_help', '', TRUE);
                                  foreach ($this->load->mdl_help->get_tracker_data() as $value) {
                            ?>
                    <tr>
                        <td><?=$value->title; ?></td>
                        <td><?=$value->content; ?></td>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                    ...
                    <div class="modal-body">
                            ...
                            <img id="image_upload_preview1" src="<?=base_url();?>/assets/images/tracker_data/<?=$value->image_data;?>"  alt="Place your Photo Item here" width="100%" height="auto"/>
        ...
        function(isConfirm){
          if (isConfirm) {
            swal({
                ...
                function(){
                  window.location.href="<?php echo base_url(); ?>help/tracker_delete_process/"+del_id;
                });
          } else {
