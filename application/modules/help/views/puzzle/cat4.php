...
<div class="sample container">
    ...
    <h1 class="header_sub">GLOW FOODS</h1>
    <div id='puzzle'></div>
    <div id='words'></div>  
    <div id="def"></div>
</div>
...
<script>
  var words = [<?php $this->load->model('mdl_help', '', TRUE); foreach ($this->load->mdl_help->get_record("4") as $value) { echo '"'.str_replace(" ","",$value->name).'",'; }?>];
    
var words_def = [""];
<?php $this->load->model('mdl_help', '', TRUE); foreach ($this->load->mdl_help->get_record("4") as $value) { echo 'words_def["'.str_replace(" ","",$value->name).'"]="'.$value->facts.'";'; }?>

var words_photo = [""];
<?php $this->load->model('mdl_help', '', TRUE); foreach ($this->load->mdl_help->get_record("4") as $value) { echo 'words_photo["'.str_replace(" ","",$value->name).'"]="'.$value->photo.'";'; }?>
