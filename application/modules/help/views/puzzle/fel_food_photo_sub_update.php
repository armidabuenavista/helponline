    ...
    <div class="container">
        ...
        <div class="panel">
                        ...
                        <?php
                            ...
                            foreach($this->load->mdl_help->get_fel_content_sub_id($this->uri->segment(3, 0)) as $div_val){
...
<script type="text/javascript">
    $(document).ready(function(){
       $('#files_banner').change(function(){
           ...
           if(error == 0){
               $.ajax({
                   url:"<?php echo base_url(); ?>help/fel_sub_do_upload_banner/<?=$this->uri->segment(3, 0); ?>",
                   method:"POST",
                   data:form_data,
                   contentType:false,
                   cache:false,
