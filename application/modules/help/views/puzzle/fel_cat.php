...
<style>
    ...
    <div style="margin: 30px;">
        ...
        <div class="panel">
            <button type="button" class="btn btn-info btn-sm" data-toggle="collapse" data-target="#demo"><i class="fa fa-plus"></i> Add New Category</button>
                <div id="demo" class="collapse">
                    <form method="post" class="form-horizontal" role="form" enctype="multipart/form-data" action="<?=base_url('help/fel_cat_add_process');?>">
                        
                        <label for="title" class="control-label">FEL Category: </label>
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="text" name="title_1" required id="title_1" class="form-control" placeholder="List Numerial Value">
                            </div>
                            <div class="col-sm-8">
                                <input type="text" name="title_2" required id="title_2" class="form-control" placeholder="List Name / Food Exchange Group">
                            </div>
                            <div class="col-sm-1">
            ...
            <div class="panel-body">
                <table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="" data-sort-order="asc" class="table table-bordered table-responsive table-striped table table-hover table-striped">
                    <thead>
                        <tr>
                            <th data-field="name" data-sortable="true" >List Numerial Value </th>
                            <th data-field="facts" data-sortable="true" >List Name / Food Exchange Group</th>
    ...
    <div class="modal fade" id="<?="brochure_view_".$value->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <?=form_open_multipart(base_url().'help/fel_cat_edit_process/'.$value->id); ?>
                    
                        <label for="title" class="control-label">Title of Statements: </label>
                        <div class="row">
                            <div class="col-sm-3">
                                <input type="text" value="<?=$value->numerical_val; ?>" name="title_1" required id="title_1" class="form-control" placeholder="List Numerial Value">
                            </div>
                            <div class="col-sm-7">
                                <input type="text" value="<?=$value->name; ?>" name="title_2" required id="title_2" class="form-control" placeholder="List Name / Food Exchange Group">
                            </div>
                            <div class="col-sm-2">
        ...
        function(isConfirm){
          if (isConfirm) {
            swal({
                ...
                function(){
                  window.location.href="<?=base_url(); ?>help/fel_cat_delete_process/"+del_id;
                });
          } else {
