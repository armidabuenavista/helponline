        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <input onkeyup='compute_calc()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="weight_lbs" required class="form-control hidden" id="weight_lbs" placeholder="Weight (lbs)">
                </div>
                <div class="col-sm-5">
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <input onkeyup='compute_calc()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="feet" required class="form-control hidden" id="feet" placeholder="Feet (ft)">
                        </div>
                        <div class="col-sm-6">
                            <input onkeyup='compute_calc()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="inches" required class="form-control hidden" id="inches" placeholder="Inches (in)">
                        </div>
                    </div>
                </div>
                <div class="col-sm-5">
                ...
                <div class="col-sm-4" style="padding-top: 8%;">
                    <center>
                        <div class="con_box">
                          ...
                          <div class="centered">
                                <select onmouseleave='' style="font-size: 90%; color: #630101;" id="output_option_3" class="input form-control space_sub hidden">
...
var wc_2 = "Your waist circumference is greater than <span style='font-weight:bold; font-size: 300%;'>94 cm</span>";
...
//Driving, computer work, ironing, cooking; sits and stands most of the day; rarely gets any physical activity during the whole day.
        ...
        if(activity_dbw_unit==1){
            ...
            $("#output_message_5").html("<span style='font-weight:bold; font-size: 200%;'>"+((energy_val*0.65)/4).toFixed(2)+"</span> grams Carbohydrates");
            $("#output_message_6").html("<span style='font-weight:bold; font-size: 200%;'>"+((energy_val*0.15)/4).toFixed(2)+"</span> grams Protein");
            $("#output_message_7").html("<span style='font-weight:bold; font-size: 200%;'>"+((energy_val*0.20)/9).toFixed(2)+"</span> grams Fat");
