...
//$html = $html.'<img style="padding-top: 0px; margin-top; 0px; width: 10000%; height: auto;" src="'.base_url().'assets/images/fel_2.jpg" alt="FEL Icon" width="10000%" height="auto">';
            ...
            foreach ($this->load->mdl_help->get_fel_content_update($seg1) as $value) {
            ...
            foreach ($this->load->mdl_help->get_fel_content_update_sub($seg1) as $value) {
...
// Display image on full page
$pdf->Image(base_url().'assets/images/felbackcover.jpg', 0, 0, 300, 300, 'JPG', '', '', false, 200, '', false, false, 0, false, false, false);
