...
-->
    ...
    <div class="modal fade" data-backdrop="" id="data_view" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"><br><br><br>
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLabel"><b>Energy Requirement</b></h3>
                    </div>
    ...
    <div class="modal fade" data-backdrop="" id="data_view_bmi" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"><br><br><br>
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLabel"><b>Body Mass Index (BMI)</b></h3>
                    </div>
                    <div class="modal-body">
...
-->
    ...
    <div class="modal fade" data-backdrop="" id="data_view_whr" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content" style="padding-left: 5%; padding-right: 5%;"><br><br><br>
                    <div class="modal-body">
                        <div class="modal-header">
    ...
    <div class="modal fade" data-backdrop="" id="data_view_dbw_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content"><br><br><br>
                    <div class="modal-header">
                        <h3 class="modal-title" id="exampleModalLabel"><b>Desirable Body Weight (DBW)</b></h3>
                    </div>
                    <div class="modal-body">
