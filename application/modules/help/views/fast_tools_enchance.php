...
<style>
    p,label,li,input,#formula_1,#formula_2,#formula_3{
        color: black;
    }
...
<div style="margin-left: 2%; margin-right: 2%;">
    <h2 class="mb-4">Fast <span>Assessment </span>and Screening <span>Tools</span></h2>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <input onkeyup='compute_calc()' type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="weight" required class="form-control" id="weight" placeholder="Weight">
                    
                    <input onkeyup='compute_calc_sub()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="weight_lbs" required class="form-control hidden" id="weight_lbs" placeholder="Weight (lbs)">
                </div>
                <div class="col-sm-5">
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <input onkeyup='compute_calc()' type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="height" required class="form-control" id="height" placeholder="Height">
                    
                    <div class="row">
                        <div class="col-sm-6">
                            <input onkeyup='compute_calc_sub()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="feet" required class="form-control hidden" id="feet" placeholder="Feet (ft)">
                        </div>
                        <div class="col-sm-6">
                            <input onkeyup='compute_calc_sub()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="inches" required class="form-control hidden" id="inches" placeholder="Inches (in)">
                        </div>
                    </div>
                </div>
                <div class="col-sm-5">
                    <select onmouseleave='height_func()' name="height_unit" class="input form-control space_sub" id="height_unit">
                        ...
                        <option value="2">Feet & Inches </option>
                    </select>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <input onkeyup='compute_calc()' type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="waist_cir" required class="form-control" id="waist_cir" placeholder="Waist Circumference">
                    
                    <input onkeyup='compute_calc()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="waist_cir_in" required class="form-control hidden" id="waist_cir_in" placeholder="Waist Circumference">
                </div>
                <div class="col-sm-5">
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    <input onkeyup='compute_calc()' type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="hip_cir" required class="form-control" id="hip_cir" placeholder="Hip Circumference ">
                    
                    <input onkeyup='compute_calc()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="hip_cir_in" required class="form-control hidden" id="hip_cir_in" placeholder="Hip Circumference">
                </div>
                <div class="col-sm-5">
    ...
    <div style="padding: 5%;">   
    <div style="background-color: #74d472; padding: 1%; border: solid black 1px;">   
    <!------ Energy Requirement ------>
<!--
    <center>
        <h3><b>Energy Requirement:</b></h3>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <p style="font-familt: Century Gothic;"> <span id="energy_message"></span></p>
        </div>
    </div>
-->
        <br><br>
...
-->
        <div class="col-sm-4"><br>
            <center>
                <h1><b>Energy Requirement:</b></h1>
                <p style="font-familt: Century Gothic;"><span id="result_val9"></span></p>
            </center>
        </div>
        <div class="col-sm-8">
            <center>
    ...
    <center><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#data_view">Learn More</button></center>                  
    ...
    <div style="padding: 5%;">   
    <div style="background-color: #69b5c5; padding: 1%; border: solid black 1px;">
    <!------ Body Mass Index ------>
    <div class="row">
    ...
    <!--            <p><span style="font-weight:bold; font-size: 300%;" id="result_val2"></span> <b> years old</b></p>-->
    <!--
                <p>Gender: <span style="font-weight:bold;" id="result_val3"></span></p>
                <p>BMI: <span style="font-weight:bold;" id="result_val1"></span></p>
    -->
                <p style="font-familt: Century Gothic;"><span id="result_val4"></span></p>
            </center>
        </div>
    </div>
        <center><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#data_view_bmi">Learn More</button></center>
    ...
    <div style="padding: 5%;">   
    <div style="background-color: #e49e2f; padding: 1%; border: solid black 1px; padding-bottom: 27px;">   
    <div class="row">
        <div class="col-sm-8">
            <center>
                <!------ Waist-Hip Ratio ------>
                <h3><b>Waist-Hip Ratio:</b></h3>
<!--
...
-->
                <p style="font-familt: Century Gothic;"><span id="result_val6"></span></p>
...
-->
                <p style="font-familt: Century Gothic;"><span id="result_val5"></span></p>

                <!------ Waist-Heigh Ratio ------>
                <h3><b>Waist-Height Ratio:</b></h3>
<!--
...
-->
                <p style="font-familt: Century Gothic;"><span id="result_val7"></span></p>
            </center>
        </div>
        <div class="col-sm-4" style="padding-top: 15%;">
            <center>
                <div class="con_box">
                    ...
                    <div id="output_message_vesssel_4" style="font-size: 300%; background-color: aliceblue; color: #630101; font-weight: bold;" class="centered_waist hidden"><span id="output_message_4">00.00</span></div>
                </div>
            </center>
        </div>
    </div>
        <center><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#data_view_whr">Learn More</button></center>
    ...
    <div style="padding: 5%;">   
    <div style="background-color: #f05858; padding: 1%; border: solid black 1px;">   
    <center>
            <!------ Desirable Body Weight ------>
            <div class="row">
                <div class="col-sm-8">

                    <h3><b>Desirable Body Weight:</b></h3>
        <!--            <p>The Desirable Body Weight (DBW) is the optimal weight based on a given height which can be computed using the <span type="button" id="dbw_header1_design" data-backdrop="false" data-toggle="modal" data-target="#dbw_header2_1">Tannhauser Formula</span>, <span type="button" id="dbw_header1_design" data-backdrop="false" data-toggle="modal" data-target="#dbw_header2_2">Hamwi Formula</span> or <span type="button" id="dbw_header1_design" data-backdrop="false" data-toggle="modal" data-target="#dbw_header2_3">Body Mass Index (BMI)</span>. The DBW is used in calculating the <span type="button" id="dbw_header1_design" data-backdrop="false" data-toggle="modal" data-target="#dbw_header1">daily energy requirement.</span></p>-->
                    ...
                    <p style="font-familt: Century Gothic;"><span id="result_val8"></span></p>
                </div>
                <div class="col-sm-4" style="padding-top: 8%;">
                    <center>
                        <div class="con_box">
                          ...
                          <div class="centered">
                                <select onmouseleave='convert_calc()' style="font-size: 90%; color: #630101;" id="output_option_3" class="input form-control space_sub hidden">
                                    <option value="1">Kilogram</option>
                                    <option value="2">Pounds</option>
                                </select>
                          </div>
        ...
        <center><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#data_view_dbw_data">Learn More</button></center>
    </div>
    </div>
...
<!--Modal for Desirable Body Weight -->
<div class="modal fade" id="data_view_dbw_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Desirable Body Weight</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       <div class="modal-body">
                        <p>The Desirable Body Weight (DBW) is the optimal weight based on a given height which can be computed using the Tannhauser Formula. The DBW is used in calculating the daily energy requirement</p>
                        <br>
                        <center><p><span id="dbw_data_mode"></span></p></center>
        </div>
        <div class="modal-footer">
      </div>
    </div>
...
<!--End Modal For Desirable Body Weight -->



<!--Modal for Energy Requirement -->
<div class="modal fade" id="data_view" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Energy Requirement</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
               <p>Is the estimated amount of food energy needed to maintain normal daily physical activities and desirable body weight. Food energy can be derived from carbohydrates, proteins and fat. The usual recommended proportions for these macronutrients are 65% carbohydrates, 15% protein and 20% fat.</p>
                        <div class="row">
                            <div class="col-sm-6">
                                <center><p><span id="activity_pic"></span></p></center>
                            </div>
                            <div class="col-sm-6">
                                ...
                                <center><p style="font-familt: Century Gothic;"> <span id="energy_message"></span></p></center>
...
<!--End Modal For Energy Requirement -->
...
<!--Modal for BMI -->
<div class="modal fade" id="data_view_bmi" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Body Mass Index (BMI)</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       <div class="modal-body">
                        <p>Is an indicator of one's weight in relation to height. BMI below or above the normal range poses increased health risks.</p>
                        <br>
                        <center><p><span id="bmi_mode"></span></p></center>
     </div>
        <div class="modal-footer">
      </div>
    </div>
...
<!--Modal for Waist Heigt Ratio -->
<div class="modal fade" id="data_view_whr" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLongTitle">Waist Ratio</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
       <div class="modal-body">
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel"><b>Waist-Hip Ratio</b></h3>
                        </div>
                        <p style="text-align: justify">Waist-Hip Ratio is a useful indicator of body fat distribution which is a valuable tool in assessing health risks such as type 2 diabetes and cardiovascular diseases.</p>
                        <br>
                        <center><p><span id="whr_final_mode"></span></p></center>
                        <hr>
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel"><b>Waist-Height Ratio</b></h3>
                        </div>
                        <p style="text-align: justify">Waist-Height measurement is a new proxy measure for obesity and is calculated from measures of waist circumference divided by height in centimeters. A value greater than 0.5 may indicate obesity. </p>
                        <br>
                        <center><p><span id="whr_mode"></span></p></center>
                        
                        <p style="text-align: justify">The Waist-Height Ratio (WHtR) is a recently introduced index which is under study as a sensitive screening tool in predicting cardiometabolic risk of adults from different nations. Its key message can be simply stated as to: "keep your waist circumference to less than half your height".</p>
                        <p style="text-align: justify">WHtR is a simple and practical anthropometric index to identify higher metabolic risks among normal and overweight individuals (Hsieh, 2003)</p>
                        <p style="text-align: justify">A boundary value of WHTR =0.5 indicates increased risk for men and women (Ashwell and Hsieh, 2005).</p>
                        <p style="text-align: justify">It is suggested that WHtR should not be used as a single measure of obesity but it can be used in combination with other screening tools like waist circumference and body mass index.</p>

                        <p style="font-size: 50%;">Ashwell, M. & Hsieh, SD. (2005). Six reasons why the waist-to-height ratio is a rapid and effective global indicator for health risks of obesity and how its use could simplify the international public health message on obesity. Int J Food Sci, 56(5), 303-307.</p>
                        <p style="font-size: 50%;">Hsieh, SD, Yoshinaga H & Muto T. (2003). Waist-to-height ratio, a simple and practical index for assessing central fat distribution and metabolic risk in Japanese men and women. International Journal of Obesity, 27, 610-616. doi:10.1038/sj.ijo.0802259.</p>
                        <hr>
                        <div class="modal-header">
                            <h3 class="modal-title" id="exampleModalLabel"><b>Waist Circumference</b></h3>
                        </div>
                        <p style="text-align: justify">Waist circumference is an indirect measure of abdominal fat or central obesity. High waist circumference increases the risks of lifestyle diseases.  </p>
                        <center><p><span id="whr_mode_rest_day"></span></p></center>
                    </div>
        <div class="modal-footer">
      </div>
    </div>
...
var bmi_message1_mode = " kg/m<sup>2</sup></span> classified as <span style='font-weight:bold; color:red;'>UNDERWEIGHT</span>. This may indicate that you have a <span style='font-weight:bold; color:red;'>HIGHER RISK</span> of acquiring frequent infections, slow wound healing and recovery from illness.<br><small><i>Cut-off used: World Health Organization.</i></small>";

var bmi_message2_mode = " kg/m<sup>2</sup></span> classified as <span style='font-weight:bold; color:green;'>NORMAL</span>. This may indicate that you have a <span style='font-weight:bold; color:green;'>LOWER RISK</span> of acquiring heart diseases, hypertension, type 2 diabetes and some types of cancer.<br><small><i>Cut-off used: World Health Organization.</i></small>";

var bmi_message3_mode = " kg/m<sup>2</sup></span> classified as <span style='font-weight:bold; color:red;'>OBESE</span>. This may indicate that you have a <span style='font-weight:bold; color:red;'>HIGHER RISK</span> of acquiring heart diseases, hypertension, type 2 diabetes and some types of cancer.<br><small><i>Cut-off used: World Health Organization.</i></small>";
    
    
    
    
var bmi_message1 = " </span> <span style='font-weight:bold;'>kg/m<sup>2</sup></span> classified as <br><span style='font-weight:bold; color: #cc3333; font-size: 350%;'>UNDERWEIGHT</span>";

var bmi_message2 = " </span> <span style='font-weight:bold;'>kg/m<sup>2</sup></span> classified as <br><span style='font-weight:bold; color: #339933; font-size: 350%;'>NORMAL</span>";

var bmi_message3 = " </span> <span style='font-weight:bold;'>kg/m<sup>2</sup></span> classified as <br><span style='font-weight:bold; color: #cc3333; font-size: 350%;'>OBESE</span>";

var bmi_message4 = " </span> <span style='font-weight:bold;'>kg/m<sup>2</sup></span> classified as <br><span style='font-weight:bold; color: #cc3333; font-size: 350%;'>OVERWEIGHT</span>";
    
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

var wc_1 = "Your waist circumference is less than <span style='font-weight:bold; font-size: 300%;'>94</span>cm";

var wc_2 = "Your waist circumference is greater than <span style='font-weight:bold; font-size: 300%;'>94</span>cm";
...
var whr2_1 = "Your waist-height ratio is less than <span style='font-weight:bold; font-size: 300%;'>0.5</span>";

var whr2_2 = "Your waist-height ratio is greater than <span style='font-weight:bold; font-size: 300%;'>0.5</span>";
    
var dbw_info1 = "Your desirable body weight is <br><span style='font-weight:bold; font-size: 300%;'>";
var dbw_info2 = "</span> <br>Keep your weight within this range <br><span style='font-weight:bold; font-size: 300%;'>";
var dbw_info3 = "</span>";
    
function convert_calc(){
    var output_option_3_val = $('#output_option_3').val();
    var output_message_3_val = $('#output_message_3').val();
    ...
    if(output_option_3_val==1){
        $("#output_message_3").html(dbw_3.toFixed(2));
    }else if(output_option_3_val==2){
        var num_x = dbw_3*2.20462;
        $("#output_message_3").html(num_x.toFixed(2));
    }
...
function waist_cir_func(){
    ...
    var waist_cir_con = 0;
        ...
        if(waist_cir_unit==1){
            document.getElementById("waist_cir").type = "text";
            document.getElementById("waist_cir_in").type = "hidden";
        }else if(waist_cir_unit==2){
            document.getElementById("waist_cir").type = "hidden";
            document.getElementById("waist_cir_in").type = "text";
        }else{
...
function hip_cir_func(){
    ...
    var hip_cir_con = 0;
        ...
        if(hip_cir_unit==1){
            document.getElementById("hip_cir").type = "text";
            document.getElementById("hip_cir_in").type = "hidden";
        }else if(hip_cir_unit==2){
            document.getElementById("hip_cir").type = "hidden";
            document.getElementById("hip_cir_in").type = "text";
        }else{
...
function height_func(){
    ...
    var height_con = 0;
        ...
        if(height_unit==1){
            ...
            document.getElementById("feet").type = "hidden";
            document.getElementById("inches").type = "hidden";
        }else if(height_unit==2){
            document.getElementById("height").type = "hidden";
            document.getElementById("feet").type = "text";
            document.getElementById("inches").type = "text";
        }else{
...
function weight_func(){
    ...
    var weight_con = 0;
        ...
        if(weight_unit==1){
            ...
            document.getElementById("weight_lbs").type = "hidden";
        }else if(weight_unit==2){
            document.getElementById("weight").type = "hidden";
            document.getElementById("weight_lbs").type = "text";
        }else{
    ...
    if(weight_unit==1){
        if(weight_lbs==0){
            ...
            weight_con = weight_lbs*0.453592;
...
function formula_change1(){
    ...
    if(isNaN(dbw_2)){ dbw_2 = 0; }
    if(isNaN(dbw_3)){ dbw_3 = 0; }
    if(isNaN(dbw_4)){ dbw_4 = 0; }
    
    if(height!=0){
        $("#result_val8").html(dbw_info1+dbw_3.toFixed(2)+"</span> kg <span style='font-weight:bold; font-size: 300%;'>"+dbw_info2+(dbw_3-(dbw_4)).toFixed(2)+"</span> kg - <span style='font-weight:bold; font-size: 300%;'>"+(dbw_3+(dbw_4)).toFixed(2)+dbw_info3+" kg");        
        
        $("#output_message_3").html(dbw_3.toFixed(2));
        
        $("#dbw_data_mode").html("Your desirable body weight is "+dbw_3.toFixed(2)+" kgs. Keep your weight within this range "+(dbw_3-(dbw_4)).toFixed(2)+" to "+(dbw_3+(dbw_4)).toFixed(2)+" kgs . You can achieve your DBW by eating a healthy and balanced diet and engaging in moderate physical activity like jogging, brisk walking and aerobic dancing.");
    }else{
...
function formula_change2(){
    ...
    if(height!=0){
        var new_dbw = dbw_con*0.453591830542594;
        var new_dbw_1 = new_dbw * 0.10;
        var new_dbw_2 = new_dbw-new_dbw_1;
        var new_dbw_3 = new_dbw+new_dbw_1;
        
        if(isNaN(new_dbw)){ new_dbw = 0; }
        if(isNaN(new_dbw_1)){ new_dbw_1 = 0; }
        if(isNaN(new_dbw_2)){ new_dbw_2 = 0; }
        if(isNaN(new_dbw_3)){ new_dbw_3 = 0; }
        $("#result_val8").html(dbw_info1+new_dbw.toFixed(2)+"</span> kg <span style='font-weight:bold; font-size: 300%;'>"+dbw_info2+new_dbw_2.toFixed(2)+"</span> kg to <span style='font-weight:bold; font-size: 300%;'>"+new_dbw_3.toFixed(2)+dbw_info3+" kg");   
        
        $("#output_message_3").html(new_dbw.toFixed(2));
        
        $("#dbw_data_mode").html("Your desirable body weight is "+new_dbw.toFixed(2)+" kgs. Keep your weight within this range "+new_dbw_2.toFixed(2)+" to "+new_dbw_3.toFixed(2)+" kgs . You can achieve your DBW by eating a healthy and balanced diet and engaging in moderate physical activity like jogging, brisk walking and aerobic dancing.");
...
function formula_change3(){
    ...
    if(isNaN(dbw_1)){ dbw_1 = 0; }
    if(isNaN(dbw_2)){ dbw_2 = 0; }
    if(isNaN(dbw_3)){ dbw_3 = 0; }
    if(height!=0){
        $("#result_val8").html(dbw_info1+dbw_1.toFixed(2)+"</span> kg <span style='font-weight:bold; font-size: 300%;'>"+dbw_info2+dbw_2.toFixed(2)+"</span> kg to <span style='font-weight:bold; font-size: 300%;'>"+dbw_3.toFixed(2)+dbw_info3+" kg");
        
        $("#output_message_3").html(dbw_1.toFixed(2));
        
        $("#dbw_data_mode").html("Your desirable body weight is "+dbw_1.toFixed(2)+" kgs. Keep your weight within this range "+dbw_2.toFixed(2)+" to "+dbw_3.toFixed(2)+" kgs . You can achieve your DBW by eating a healthy and balanced diet and engaging in moderate physical activity like jogging, brisk walking and aerobic dancing.");
    }else{
       $("#result_val8").html("loading...");
    }
}
...
function compute_calc() {    
    ...
    if((weight==0)||(height==0)){
        ...
        if(bmi<=18.4){
            ...
            $("#result_val4").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message1);
            $("#bmi_mode").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message1_mode);
            if(gender==1){
        ...
        }else if((bmi>18.4)&&(bmi<=24.99)){
            bmi_class = "NORMAL";
            $("#result_val4").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message2);
            $("#bmi_mode").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message2_mode);
            if(gender==1){
            ...
            $("#result_val4").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message4);
            $("#bmi_mode").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message3_mode);
            if(gender==1){
            ...
            bmi_class = "OBESE";
            $("#result_val4").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message3);
            $("#bmi_mode").html("Your BMI is <span style='font-weight:bold; font-size: 300%;'>"+bmi+bmi_message3_mode);
            if(gender==1){
    ...
    if(height!=0){
        if(isNaN(dbw_3)){ dbw_3 = 0; }
        var dbw3_sub1 = dbw_3-(dbw_4);
        var dbw3_sub2 = dbw_3+(dbw_4);
        if(isNaN(dbw3_sub1)){ dbw3_sub1 = 0; }
        if(isNaN(dbw3_sub2)){ dbw3_sub2 = 0; }
        
        $("#result_val8").html(dbw_info1+dbw_3.toFixed(2)+"</span> kg <span style='font-weight:bold; font-size: 300%;'>"+dbw_info2+(dbw3_sub1).toFixed(2)+"</span> kg - <span style='font-weight:bold; font-size: 300%;'>"+(dbw3_sub2
        ).toFixed(2)+"</span> kg "+dbw_info3);
        
        $("#dbw_data_mode").html("Your desirable body weight is "+dbw_3.toFixed(2)+" kgs. Keep your weight within this range "+dbw3_sub1.toFixed(2)+" to "+dbw3_sub2.toFixed(2)+" kgs . You can achieve your DBW by eating a healthy and balanced diet and engaging in moderate physical activity like jogging, brisk walking and aerobic dancing.");
    ...
    if((age>=1)&&(age<=18)){
        $("#result_val9").html("YOU NEED <span style='font-weight:bold; font-size: 300%;'>"+energy+"</span> KCAL PER DAY DISTRIBUTED");
    }else if(age>=19){
        ...
        $("#output_2").html('<img src="<?=base_url();?>assets/images/fast/calculator_avatar/chart_avatar_final.png" alt="Bar Level" width="90%" height="auto">');
...
//Child care, garage work, electrical trades exercises or walks 3-5 times per week at a slow pace of 2.5 - 3 mph for less than 30 minutes per session.
//Heavy housework, yard work, carrying a load, cycling, tennis, dancing; exercises or walks 3.5 - 4 mph for one hour 3-5 times per week.
//Heavy manual labor such as construction work, digging, climbing, carrying a load uphill, professional sports; exercises 3-5 times per week for 1 1/2 hours per session.
//Driving, computer work, ironing, cooking; sits and stands most of the day; rarely gets any physical activity during the whole day.
        ...
        if(activity_dbw_unit==1){
            ...
            var val_ener_1 = energy_val.toFixed(2);
            var val_ener_1_1 = val_ener_1.split(".");
            var val_ener_1_2 = 0;
            var val_ener_1_3 = 0;
            if(val_ener_1_1[0]<=100){
                var val_ener_1_2 = val_ener_1_1[0].substr(1,3); 
                if(val_ener_1_2>=51){
                    val_ener_1_3 =100
                }else{
                    val_ener_1_3 =50
                }
            }else if(val_ener_1_1[0]<=1000){
                var val_ener_1_2 = val_ener_1_1[0].substr(1,4); 
                if(val_ener_1_2>=51){
                    val_ener_1_3 = (parseInt(val_ener_1_1[0].substr(0,2))+1)+"00";
                }else{
                    val_ener_1_3 = (val_ener_1_1[0].substr(0,2))+"50";
                }
            }else if(val_ener_1_1[0]<10000){
                var val_ener_1_2 = val_ener_1_1[0].substr(2,5); 
                if(val_ener_1_2>=51){
                    val_ener_1_3 = (parseInt(val_ener_1_1[0].substr(0,2))+1)+"00";
                }else{
                    val_ener_1_3 = (val_ener_1_1[0].substr(0,2))+"50";
            ...
            $("#result_val9").html("YOU NEED <span style='font-weight:bold; font-size: 300%;'>"+val_ener_1_3+"</span> KCAL PER DAY DISTRIBUTED");
            ...
            var val_1 = ((energy_val*0.65)/4).toFixed(2);
            var val_2 = ((energy_val*0.15)/4).toFixed(2);
            var val_3 = ((energy_val*0.20)/9).toFixed(2);
            
            var val_1_1 = val_1.split(".");
            var val_2_1 = val_2.split(".");
            var val_3_1 = val_3.split(".");
            ...
            if(val_1_1[0]<10){
                var val_1_2 = val_3_1[0].substr(0,1); 
                if(val_1_2>=6){
                    val_1_3 =10
                }else{
                    val_1_3 =5
                }
            }else if(val_1_1[0]<100){
                var val_1_2 = val_1_1[0].substr(2,3); 
                if(val_1_2>=6){
                    val_1_3 = (parseInt(val_1_1[0].substr(0,1))+1)+"0";
                }else{
                    val_1_3 = (val_1_1[0].substr(0,1))+"5";
                }
            }else if(val_1_1[0]<1000){
                var val_1_2 = val_1_1[0].substr(3,4); 
                if(val_1_2>=6){
                    val_1_3 = (parseInt(val_1_1[0].substr(0,2))+1)+"0";
                }else{
                    val_1_3 = (val_1_1[0].substr(0,2))+"5";
                }
            }
            
            if(val_2_1[0]<10){
                var val_2_2 = val_3_1[0].substr(0,1); 
                if(val_2_2>=6){
                    val_2_3 =10
                }else{
                    val_2_3 =5
                }
            }else if(val_2_1[0]<100){
                var val_2_2 = val_2_1[0].substr(2,3); 
                if(val_2_2>=6){
                    val_2_3 = (parseInt(val_2_1[0].substr(0,1))+1)+"0";
                }else{
                    val_2_3 = (val_2_1[0].substr(0,1))+"5";
                }
            }else if(val_2_1[0]<1000){
                var val_2_2 = val_2_1[0].substr(3,4);
                if(val_2_2>=6){
                    val_2_3 = (parseInt(val_2_1[0].substr(0,2))+1)+"0";
                }else{
                    val_2_3 = (val_2_1[0].substr(0,2))+"5";
                }
            }
            
            if(val_3_1[0]<10){
                var val_3_2 = val_3_1[0].substr(0,1); 
                if(val_3_1>=6){
                    val_3_3 =10
                }else{
                    val_3_3 =5
                }
            }else if(val_3_1[0]<100){
                var val_3_2 = val_3_1[0].substr(2,3); 
                if(val_3_2>=6){
                    val_3_3 = (parseInt(val_3_1[0].substr(0,1))+1)+"0";
                }else{
                    val_3_3 = (val_3_1[0].substr(0,1))+"5";
                }
            }else if(val_3_1[0]<1000){
                var val_3_2 = val_3_1[0].substr(3,4); 
                if(val_3_2>=6){
                    val_3_3 = (parseInt(val_3_1[0].substr(0,2))+1)+"0";
                }else{
                    val_3_3 = (val_3_1[0].substr(0,2))+"5";
                }
            }
            
            $("#output_message_5").html("<span style='font-weight:bold; font-size: 200%;'>"+val_1_3+"</span> g Carbohydrates");
            $("#output_message_6").html("<span style='font-weight:bold; font-size: 200%;'>"+val_2_3+"</span> g Protein");
            $("#output_message_7").html("<span style='font-weight:bold; font-size: 200%;'>"+val_3_3+"</span> g Fat");
            
        }else if(activity_dbw_unit==2){
            var energy_val = dbw_3.toFixed(2)*35;
            $("#result_val9").html("YOU NEED <span style='font-weight:bold; font-size: 300%;'>"+energy_val+"</span> KCAL PER DAY DISTRIBUTED");
...
//    $("#result_val3").html(sex);
    ...
    if(height!=0){
        if(gender==1){
            if(waist_cir<=94){
               ...
               $("#whr_mode").html("Your waist-height ratio is less than 0.5 which may indicate <span style='color: #339933;'>LOWER RISK</span> to obesity-related diseases such as hypertension, heart disease and type 2 diabetes.");
            }else{
               $("#result_val5").html(wc_2);
               $("#whr_mode").html("Your waist-height ratio is greater than 0.5 which may indicate <span style='color: #cc3333;'>HIGHER RISK</span> to obesity-related diseases such as hypertension, heart disease and type 2 diabetes.");
            }
        }else if(gender==2){
            if(waist_cir<=80){
               $("#result_val5").html(wc_1);
    ...
    if((waist_cir==0)||(hip_cir==0)){
        ...
        if(isNaN(whr_final_result1)){ whr_final_result1 = 0; }
        if(gender==1){
            ...
            if(whr_final_result1<=0.90){
                ...
                $("#whr_final_mode").html("Your waist hip ratio is <span style='font-weight: bold; color: #339933;'>"+whr_final_result1+"</span> which may indicate LOWER RISK of developing obesity-related diseases like heart diseases, hypertension and type 2 diabetes.");
                
               $("#result_val6").html("Your waist hip ratio is <span style='font-weight:bold; font-size: 300%;'>"+whr_final_result1+whr1_1);
            }else{
                
                document.getElementById("output_message_vesssel_4").className = "centered_waist";
                $("#output_message_4").html(whr_final_result1);
                
                $("#whr_final_mode").html("Your waist hip ratio is <span style='font-weight: bold; color: #cc3333;'>"+whr_final_result1+"</span> which may indicate HIGHER RISK of developing obesity-related diseases like heart diseases, hypertension and type 2 diabetes.");
                
               $("#result_val6").html("Your waist hip ratio is <span style='font-weight:bold; font-size: 300%;'>"+whr_final_result1+whr1_2);
            }
        }else if(gender==2){
        ...
        if(gender==1){
            if(whr_final_result2<=0.5){
               $("#result_val7").html(whr2_1);
                $("#whr_mode_rest_day").html("Your waist circumference is within the cut-off value of <span style='font-weight: bold; color: #339933;'>less than 94 cm</span> which may indicate LOW RISK of developing cardiovascular diseases and type-2 diabetes.");
            }else{
               $("#result_val7").html(whr2_2);
                $("# whr_mode_rest_day").html("Your waist circumference is above the cut-off value of <span style='font-weight: bold; color: #cc3333;'>greater than 94 cm</span> which may indicate HIGH RISK of developing cardiovascular diseases and type-2 diabetes.");
            }
        }else if(gender==2){
            if(whr_final_result2<=0.5){
               $("#result_val7").html(whr2_1);
