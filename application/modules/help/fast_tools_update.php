        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <input onkeyup='compute_calc()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="waist_cir_in" required class="form-control hidden" id="waist_cir_in" placeholder="Waist Circumference (In)">
                </div>
                <div class="col-sm-5">
        ...
        <div class="col-sm-4">
            ...
            <div class="row">
                <div class="col-sm-7">
                    ...
                    <input onkeyup='compute_calc()' type="hidden" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" min="0" type='text' maxlength="7" max="1000" name="hip_cir_in" required class="form-control hidden" id="hip_cir_in" placeholder="Hip Circumference (In)">
                </div>
                <div class="col-sm-5">
