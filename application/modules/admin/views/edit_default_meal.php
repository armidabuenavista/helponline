...
<?php 
  foreach ($results as $row) {
 	...
 	echo "<div class=\"table-responsive\">";
          ...
          echo "<td colspan=\"2\">";
          echo "<button  id=\"update_default_meal1\" class=\"btn btn-primary btn-lg\" data-id1=\" $id\"   data-meal1=\"$meal_code\" data-meal_id1=\"$meal_id\" data-menu_id1=\"$menu_id\" data-nutrition_id=\"$data_id\"> Update</button>";
          echo "</td>";
          echo "</tr>";
          echo "</table>";
